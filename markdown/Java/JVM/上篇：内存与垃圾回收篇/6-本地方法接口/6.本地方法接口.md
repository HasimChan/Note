...
* 简单地讲，**一个Native Method 就是一个Java调用非Java代码的接囗**。一个Native Method是这样一个Java方法：该方法的实现由非Java语言实现，比如C。这个特征并非Java所特有，很多其它的编程语言都有这一机制，比如在C++中，你可以用extern "c" 告知c++编译器去调用一个c的函数
...
![image-20200706164139252](6.本地方法接口.assets/image-20200706164139252.png)

```java
/**
 * 本地方法，有方法体，与abstract不同
 */
